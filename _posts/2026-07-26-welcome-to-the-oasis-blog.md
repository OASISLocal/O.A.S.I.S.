...
This is where we'll post release notes, technical deep dives, and honest updates on where OASIS is headed — the same roadmap you see on the homepage, with the reasoning behind it.

A few things to expect here:

- **Release notes** every time a new version ships, in plain language, not just a changelog dump.
